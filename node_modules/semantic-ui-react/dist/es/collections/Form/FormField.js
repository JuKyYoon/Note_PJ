...
import { createHTMLLabel, customPropTypes, getElementType, getUnhandledProps, META, SUI, useKeyOnly, useWidthProp } from '../../lib';
...
function FormField(props) {
  ...
  if (_isNil(control)) {
    if (_isNil(label)) return React.createElement(
      ElementType,
